...
<!-- Hints Section End -->
  ...
  <form class="concours-form" action="index.php?action=concours" method="post">
    ...
    <div class="concours-formGroup">
      ...
      <input class="concours-formInput" type="number" min="-180" max="180" step="0.00000001" name="userInputLatitude" value="" <?php if ($_SESSION['attemptsNumber']<1){echo "required";} ?>>


    </div>
    <div class="concours-formGroup">
      <label class="concours-formLabel" for="userInputLongitude">Longitude (Y.yyyyy)</label>
      <input class="concours-formInput" type="number" min="-180" max="180" step="0.00000001" name="userInputLongitude" value=""  <?php if ($_SESSION['attemptsNumber']<1){echo "required";} ?>>
    </div>
